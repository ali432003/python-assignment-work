...
class Dog(Pet):
    ...
    def feed(self):
        Pet.feed(self)  # super().feed() it refrences the parent class
        print("Arf! Thanks!")
...
pet_types = {'dog': Dog, 'lab': Lab, 'poodle': Poodle, 'cat': Cat, 'bird': Bird,'tiger':Tiger,'rabbit':Rabbit}
